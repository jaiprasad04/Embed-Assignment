...
const Categories = () => {
    ...
    const categoryWise = charactersList.filter(each => (
    ...
    return (
        <div className="category-container">
            <ul className="category-list">
                {tabsList.map((each) => (
                    <CategoryItems key={each.tabId} clickTabItem={clickTabItem} isActive={activeTabId === each.tabId} data={each} />
                ))}
            </ul>
                    ...
                    {categoryWise.map((each, index) => (
                        ...
                        <div className="character-details-container">
                            ...
                            <div className="comments-section">
                                ...
                                {each.likes ? (<div className="comments-section">
